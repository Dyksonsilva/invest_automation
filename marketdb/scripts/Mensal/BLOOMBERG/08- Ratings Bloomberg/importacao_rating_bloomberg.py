# -*- coding: utf-8 -*-
"""
Created on Tue Jun 14 10:33:08 2016
...
#importar rating por contraparte
...
planilha = root+'/codigo_fonte_final/bloomberg - rating - manual/levantamento de contrapartes '+dt_ref+'.xlsx'

bancos=pd.read_excel(planilha, sheetname='bancos_sem_Link',skiprows=1, header=0)
...
contraparte_rtg['cnpj'].str.zfill(14)
...
isin=pd.read_excel(planilha, sheetname='isin_sem_link',skiprows=1, header=0)
...
isin_rtg_fim['cnpj'].str.zfill(14)
