"""
Django settings for invest_automation project.
...
SECRET_KEY = 'w^^v7o#oiczn$%kt$pac#qem6+0m@w#0s8gy=c0yxitie4eloj'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['10.36.180.145']
...
ROOT_URLCONF = 'invest_automation.urls'
...
WSGI_APPLICATION = 'invest_automation.wsgi.application'
